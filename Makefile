...
ALL_CFLAGS  = -g -mcpu=$(MCU) $(THUMB_IW) -I. $(CFLAGS) $(TARGETFLAGS) $(GENDEPFLAGS) $(MATRIXFLAGS)
...
# vALL: MATRIXFLAGS += -DMATRIX_VERSION $(0)
# v110: MATRIXFLAGS += -DMATRIX_VERSION $(110)
# v120:	MATRIXFLAGS += -DMATRIX_VERSION $(120)
# v150:	MATRIXFLAGS += -DMATRIX_VERSION $(150)

build: elf bin lss sym

build_matrix: TARGETFLAGS= -DTARGET_MXPT $(DEFINES)
# Set the linker script
build_matrix: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_matrix: elf bin lss sym
copy_matrix:
	@echo
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin bootloader_only_binaries/matrix.bin
	@echo

build_matrix_v120: TARGETFLAGS= -DTARGET_MXPT120 $(DEFINES)
# Set the linker script
build_matrix_v120: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_matrix_v120: elf bin lss sym
copy_matrix_v120:
	@echo
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin bootloader_only_binaries/matrix_v120.bin
	@echo

build_matrix_v150: TARGETFLAGS= -DTARGET_MXPT150 $(DEFINES)
# Set the linker script
build_matrix_v150: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_matrix_v150: elf bin lss sym
copy_matrix_v150:
	@echo
	@echo "Copying to binaries folder"
	@echo
